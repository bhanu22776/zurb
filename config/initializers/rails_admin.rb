# RailsAdmin config file. Generated on February 03, 2014 19:02
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Zurb', 'Admin']
  ...
  # config.excluded_models = ['Member', 'Photo', 'Social', 'User', 'Video']

  # Include specific models (exclude the others):
  # config.included_models = ['Member', 'Photo', 'Social', 'User', 'Video']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your social.rb model definition
